...
abstract class BaseRepository {
    ...
    public function create($entity) {
        try {
            ...
            $sqlQuery = $this->pdo->prepare("INSERT INTO {$this->table} (" . implode(", ", $columns) . ") VALUES ($valuesString)");
    ...
    public function update($data) {
        ...
        try {
            ...
            $sqlQuery = $this->pdo->prepare("UPDATE {$this->table} SET $setString WHERE id = :id");
    ...
    public function delete($id) {
        $sqlQuery = $this->pdo->prepare("DELETE FROM {$this->table} WHERE id = :id");
    ...
    public function softDelete($id) {
        ...
        try {
            $sqlQuery = $this->pdo->prepare("UPDATE {$this->table} SET deleted_at = :deleted_at WHERE id = :id");
